  ...
  return (
    <header className="sticky top-0 z-50 bg-surface/95 backdrop-blur border-b border-border">
      <div className="container flex items-center justify-between py-4">
        ...
        {/* Icône compte, visible aussi en mobile */}
        <a
          href="/compte"
          aria-label="Mon compte"
          className="flex md:hidden items-center justify-center w-10 h-10 rounded-full bg-indigo text-white hover:opacity-90 transition-opacity"
        >
          <AccountIcon />
        </a>
      </div>
